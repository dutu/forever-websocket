...
`options.automaticOpen` | boolean  | \<optional\>  | `true` | Controls if WebSocket should be created and connected outomatically to the server. See also [`connect()`](#method-connect)
